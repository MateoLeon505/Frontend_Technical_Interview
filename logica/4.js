...
// * getGeoInfo: Función que Realiza una solicitud GET a una API (posiblemente relacionada con geolocalización). Si 
//   la solicitud  tiene éxito, obtiene el código de país (country_code) de la respuesta y lo establece en algún 
//   lugar (probablemente en el estado).
